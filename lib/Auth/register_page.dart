...
class _RegisterPageState extends State<RegisterPage> {
  ...
  String _selectedAvatar = 'https://cdn-icons-png.flaticon.com/512/924/924915.png'; // Default
  bool _isLoading        = false;
  bool _obscure          = true;
  int _step              = 0; // 0 = account, 1 = body, 2 = personalization
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    _step == 0 ? 'Create your\naccount.' : _step == 1 ? 'About\nyour body.' : 'Personalize\nyour profile.',
                    style: const TextStyle(
                      fontSize: 34,
  ...
  Widget _stepOne() {
    return Column(
      children: [
        _field('Full Name', _nameController, icon: Icons.badge_outlined),
        _field('Username', _usernameController, icon: Icons.alternate_email_rounded),
        _field('Email', _emailController, icon: Icons.mail_outline_rounded, keyboard: TextInputType.emailAddress),
        _field('Password', _passwordController, icon: Icons.lock_outline_rounded, obscure: true),
  ...
  Widget _stepTwo() {
    return Column(
      children: [
        Row(children: [
          Expanded(child: _field('Age', _ageController, icon: Icons.cake_outlined, keyboard: TextInputType.number)),
          const SizedBox(width: 12),
          Expanded(child: _field('City', _cityController, icon: Icons.location_city_outlined)),
        ]),
        Row(children: [
          Expanded(child: _field('Height (cm)', _heightController, icon: Icons.height_rounded, keyboard: TextInputType.number)),
          const SizedBox(width: 12),
          Expanded(child: _field('Weight (kg)', _weightController, icon: Icons.monitor_weight_outlined, keyboard: TextInputType.number)),
        ]),
        _dropdown(
          label: 'Gender',
  ...
  Widget _field(String label, TextEditingController controller, {required IconData icon, bool obscure = false, TextInputType keyboard = TextInputType.text}) {
    return Padding(
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: obscure
              ? GestureDetector(
                  ...
                  child: Icon(_obscure ? Icons.visibility_off_rounded : Icons.visibility_rounded, color: AppColors.textSecondary, size: 19),
                )
              : null,
  ...
  Widget _dropdown({required String label, required String value, required List<String> items, required void Function(String?) onChanged}) {
    return Container(
      ...
      child: DropdownButtonFormField<String>(
        value: value,
        decoration: InputDecoration(labelText: label, labelStyle: const TextStyle(color: AppColors.textSecondary, fontSize: 13), border: InputBorder.none),
  ...
  Widget _nextButton(String label, VoidCallback onTap) {
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        child: Text(label, style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w700, color: AppColors.white)),
      ),
    );
  }
}
